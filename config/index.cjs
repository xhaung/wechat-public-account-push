...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: '9ASQsitP4ysCvHZ2dFxoYxtntZFidaADBMN3SDVeVSE',
      ...
      festivals: [
        ...
        {
          type: '节日', name: '在一起！', year: '2022', date: '05-02',
        },
        """
      ],
      // 我们在一起已经有xxxx天了的配置
  ...
  CALLBACK_TEMPLATE_ID: '9ASQsitP4ysCvHZ2dFxoYxtntZFidaADBMN3SDVeVSE',
